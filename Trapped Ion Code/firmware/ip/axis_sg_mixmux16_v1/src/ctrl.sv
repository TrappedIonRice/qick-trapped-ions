...
output					fifo_rd_en_o;
input					fifo_empty_i;
input	[47:0]			fifo_dout_i; // was [39:0]
output	[15:0]			mask_o; // was [7:0]
output					en_o;
...
// Fifo dout register.
reg		[47:0]	fifo_dout_r; // was [39:0]

// Number of samples.
wire	[31:0]	nsamp_int;

// Mask.
wire	[15:0]	mask_int; // was [7:0]
wire	[15:0]	mask_la; // was [7:0]
...
assign mask_int		= fifo_dout_r[47:32]; // was [39:32]
